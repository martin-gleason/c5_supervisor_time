...
stearing committe is `r number_of_tasks`, for a total of `r total_hours` hours. This translates to `r round(total_hours/8, 0)` days. Below is a graph represents the work done by Steering Committee members.
